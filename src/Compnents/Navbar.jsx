...
export const Navbar = () => {
  return (
    <div className='flex w-[100vw] bg-black text-purple-600 justify-between'>
        ...
        <ul className='flex gap-5 p-4 cursor-pointer'>
          ...
          <li><button className='relative -top-0.5 w-auto bg-white text-purple-500 font-bold py-1 px-2  rounded-lg shadow-md hover:border-white hover:shadow-purple-900  flex items-center group'>
            <span>Resume</span>
