...
// import './CSS files/Carousel.css'; // Keep this if you have custom styles; otherwise, it can be removed.
...
//   return (
//     <div ref={ref} className='Carousel-main flex items-center justify-between max-h-fit lg:justify-evenly sm:justify-start'>
//       <div className='front-header text-purple-500 text-xl lg:w-60 mx-7'>
//         <img className='w-[55%] ml-7 -mt-10 lg:w-[100%] sm:ml-0 m-0' src={headerImage} alt="Header" />
//       </div>
//       <div ref={carouselRef} className="carousel mx-5 flex justify-start overflow-hidden sm:mx-0 right-4">
//         <div
...
//             <div key={index} className="carousel-slide mx-5 lg:mx-0 sm:-mx-4" style={{ width: '140px' }}>
...
//         </div>
//         <button
//           className="carousel-control prev absolute top-1/2 transform -translate-y-1/2 left-[-25px] z-10"
//           onClick={prevSlide}
//         >
//           &#10094;
//         </button>
//         <button
//           className="carousel-control next absolute top-1/2 transform -translate-y-1/2 right-[-25px] z-10"
//           onClick={nextSlide}
//         >
//           &#10095;
//         </button>
